     ...
     -->
        <div class="col-12 col-md-9 col-sm-9">
            <div class="row">
                ...
                <div class="col-md-4">
              <div class="thumbnail">
                <img src="${pageContext.request.contextPath}/Resources/images/${pro.pImg}" alt=${pro.pImg } class="img-responsive" height="70" width="80">
                <div class="caption">
                  <h4 class="pull-right">$ <span>${pro.pPrice }</span></h4>
                  <h4><a href="#">${pro.pName }</a></h4>
                  <p>${pro.pDescription }</p>
                </div>
                <div class="ratings">
                  <p>
                ...
                <div class="btn-ground text-center">
                    ...
                    <!-- <a href="addIntoCart">Add To Cart</a> -->
